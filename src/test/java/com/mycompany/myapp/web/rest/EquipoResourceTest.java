...
public class EquipoResourceTest {
    ...
    public void initTest() {
        ...
        equipo.setCreacion(DEFAULT_CREACION);
    ...
    public void createEquipo() throws Exception {
        ...
        assertThat(testEquipo.getCreacion()).isEqualTo(DEFAULT_CREACION);
    ...
    public void updateEquipo() throws Exception {
        ...
        equipo.setCreacion(UPDATED_CREACION);
        ...
        assertThat(testEquipo.getCreacion()).isEqualTo(UPDATED_CREACION);
