    ...
    .config(function ($stateProvider) {
        $stateProvider
            .state('entrenador', {
                ...
                data: {
                    roles: ['ROLE_USER'],
                    pageTitle: 'jhipsterApp.entrenador.home.title'
                },
                views: {
                    'content@': {
            ...
            .state('entrenador.detail', {
                ...
                data: {
                    roles: ['ROLE_USER'],
                    pageTitle: 'jhipsterApp.entrenador.detail.title'
                },
                views: {
                    'content@': {
            ...
            .state('entrenador.new', {
                ...
                onEnter: ['$stateParams', '$state', '$modal', function($stateParams, $state, $modal) {
                    $modal.open({
                        ...
                        resolve: {
                            entity: function () {
                                return {nombre: null, nacimiento: null, nacionalidad: null, partidos: null, id: null};
                            }
                        }
